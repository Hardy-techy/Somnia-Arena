      ...
      <div className="relative isolate px-6 pt-14 lg:px-8 z-10">
        ...
        >
          <div
            ...
            className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#8b5cf6]/30 via-[#00ff88]/30 to-[#00d4ff]/30 opacity-80 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem] animate-pulse" style={{ animationDelay: '3s' }}
          />
        </div>
      </div>
    </div>
